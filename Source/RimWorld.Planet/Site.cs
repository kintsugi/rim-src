	...
	public int WorldObjectTimeoutTicksLeft
	{
		get
		{
			...
			for (int i = 0; i < questsListForReading.Count; i++)
			{
				...
				{
					if (quest.PartsListForReading[j] is QuestPart_WorldObjectTimeout questPart_WorldObjectTimeout && questPart_WorldObjectTimeout.State == QuestPartState.Enabled && questPart_WorldObjectTimeout.worldObject == this)
					{
