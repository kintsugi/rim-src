...
public class RegionCostCalculator
{
	...
	{
		IntVec3 obj = (linkTargetCells.ContainsKey(a) ? linkTargetCells[a] : RegionLinkCenter(a));
		IntVec3 intVec = (linkTargetCells.ContainsKey(b) ? linkTargetCells[b] : RegionLinkCenter(b));
