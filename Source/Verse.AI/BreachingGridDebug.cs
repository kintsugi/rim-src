...
public static class BreachingGridDebug
{
	...
	[DebugAction("Pawns", "Draw breach path...", false, false, false, 0, false, actionType = DebugActionType.Action, allowedGameStates = AllowedGameStates.PlayingOnMap, hideInSubMenu = true)]
