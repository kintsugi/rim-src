...
public static class HaulAIUtility
{
	...
	{
		if (t is UnfinishedThing unfinishedThing && unfinishedThing.BoundBill != null && (!(unfinishedThing.BoundBill.billStack.billGiver is Building building) || (building.Spawned && building.OccupiedRect().ExpandedBy(1).Contains(unfinishedThing.Position))))
		{
			return false;
		}
