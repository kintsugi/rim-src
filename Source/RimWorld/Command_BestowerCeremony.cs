...
public class Command_BestowerCeremony : Command
{
	...
	public override void ProcessInput(Event ev)
	{
		...
		Find.WindowStack.Add(new Dialog_BeginRitual("ChooseParticipantsBestow".Translate(), "RitualBestowingCeremony".Translate(), null, job.targetSpot.ToTargetInfo(bestower.Map), bestower.Map, delegate(RitualRoleAssignments assignments)
		{
