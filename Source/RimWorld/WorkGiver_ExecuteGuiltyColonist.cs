...
public class WorkGiver_ExecuteGuiltyColonist : WorkGiver_Scanner
{
	...
	{
		Pawn pawn2 = (Pawn)t;
		if (pawn2 == null || pawn2.guilt == null || !pawn2.guilt.IsGuilty || !pawn2.guilt.awaitingExecution || !pawn2.Spawned || pawn2.InAggroMentalState || pawn2.IsForbidden(pawn) || pawn2.IsFormingCaravan() || !pawn.CanReserveAndReach(pawn2, PathEndMode.Touch, pawn.NormalMaxDanger(), 1, -1, null, forced))
		{
			return null;
		}
