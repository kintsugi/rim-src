...
public class CompPlantHarmRadius : ThingComp
{
	...
	{
		return "FoliageKillRadius".Translate() + ": " + CurrentRadius.ToString("0.0") + "\n" + "RadiusExpandRate".Translate() + ": " + "PerDay".Translate(Math.Round(PropsPlantHarmRadius.radiusPerDayCurve.Evaluate(AgeDays + 1f) - PropsPlantHarmRadius.radiusPerDayCurve.Evaluate(AgeDays)));
	}
