...
public abstract class RitualOutcomeEffectWorker : IExposable
{
	...
	public virtual OutcomeChance GetForcedOutcome(Precept_Ritual ritual, TargetInfo ritualTarget, RitualObligation obligation, RitualRoleAssignments assignments)
	{
		return null;
	}
