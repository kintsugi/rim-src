...
public static class IdeoDevelopmentUtility
{
	...
	{
		if (!(ritual.outcomeEffect is RitualOutcomeEffectWorker_FromQuality ritualOutcomeEffectWorker_FromQuality) || !ritualOutcomeEffectWorker_FromQuality.GivesDevelopmentPoints)
		{
			return null;
		}
