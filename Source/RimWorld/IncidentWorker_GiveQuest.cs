...
public class IncidentWorker_GiveQuest : IncidentWorker
{
	...
	{
		GiveQuest(parms, parms.questScriptDef = def.questScriptDef ?? parms.questScriptDef ?? NaturalRandomQuestChooser.ChooseNaturalRandomQuest(parms.points, parms.target));
		return true;
	}
