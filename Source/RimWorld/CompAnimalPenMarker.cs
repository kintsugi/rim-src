...
public class CompAnimalPenMarker : CompAutoCut
{
	...
	public override void PostSpawnSetup(bool respawningAfterLoad)
	{
		...
		if (!respawningAfterLoad && label.NullOrEmpty())
		{
			...
			autoCutFilter.CopyAllowancesFrom(parent.Map.animalPenManager.GetDefaultAutoCutFilter());
	...
	protected override bool CanDesignatePlant(Plant plant)
	{
		if (base.CanDesignatePlant(plant))
		{
			return GetFixedAutoCutFilter().Allows(plant);
		}
		return false;
	}
