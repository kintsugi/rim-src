...
public class Alert_PennedAnimalHungry : Alert
{
	...
	private void CalculateTargets()
	{
		...
		{
			if (AnimalPenUtility.NeedsToBeManagedByRope(item) && item.needs.food.TicksStarving > 2500 && AnimalPenUtility.GetCurrentPenOf(item, allowUnenclosedPens: false) != null)
			{
				targets.Add(item);
