...
public static class AddictionUtility
{
	...
	{
		ModifyChemicalEffectForToleranceAndBodySize_NewTemp(pawn, chemicalDef, ref effect, applyGeneToleranceFactor: false);
	}

	public static void ModifyChemicalEffectForToleranceAndBodySize_NewTemp(Pawn pawn, ChemicalDef chemicalDef, ref float effect, bool applyGeneToleranceFactor)
	{
		if (chemicalDef != null)
		{
