...
public class ScenPart_StartingMech : ScenPart
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		overseenByPlayerPawnChance = Widgets.HorizontalSlider_NewTemp(rect2, overseenByPlayerPawnChance, 0f, 1f, middleAlignment: false, overseenByPlayerPawnChance.ToStringPercent(), null, null, 0.01f);
	}
