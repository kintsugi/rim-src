...
public class StatPart_Genes : StatPart
{
	...
	{
		if (ModsConfig.BiotechActive && req.HasThing && req.Thing is Genepack genepack && genepack.GeneSet != null)
		{
	...
	public override string ExplanationPart(StatRequest req)
	{
		...
		if (!req.HasThing || !(req.Thing is Genepack genepack) || genepack.GeneSet == null)
		{
			return text;
		}
