...
public class CompTargetingBeam : ThingComp
{
	...
	{
		base.PostDraw();
		if (parent != null && parent is Pawn pawn && pawn.stances != null && pawn.stances.curStance is Stance_Warmup stance_Warmup && stance_Warmup.verb != null && stance_Warmup.verb is Verb_Shoot)
		{
