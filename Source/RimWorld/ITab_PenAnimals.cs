...
public class ITab_PenAnimals : ITab_PenBase
{
	...
	protected override void FillTab()
	{
		...
		ThingFilterUI.DoThingFilterConfigWindow(bottom, animalFilterState, selectedCompAnimalPenMarker.AnimalFilter, AnimalPenUtility.GetFixedAnimalFilter(), 1, null, null, forceHideHitPointsConfig: false, null, map);
	}
}
