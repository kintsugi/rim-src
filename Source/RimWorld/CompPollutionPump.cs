...
public class CompPollutionPump : ThingComp
{
	...
	{
		base.CompTick();
		if (Props.disabledByArtificialBuildings && Find.TickManager.TicksGame % 60 == 0)
		{
			disabledByArtificialBuildings = Find.CurrentMap.listerArtificialBuildingsForMeditation.GetForCell(parent.Position, Props.radius).Count > 0;
		}
