...
public class WorkGiver_Warden_Chat : WorkGiver_Warden
{
	public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
	{
		...
		if ((interactionMode == PrisonerInteractionModeDefOf.AttemptRecruit || interactionMode == PrisonerInteractionModeDefOf.ReduceResistance) && !pawn2.guest.ScheduledForInteraction)
		{
