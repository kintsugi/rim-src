...
public class Designator_ReleaseAnimalToWild : Designator
{
	...
	{
		if (t is Pawn pawn && pawn.RaceProps.Animal && pawn.Faction == Faction.OfPlayer && base.Map.designationManager.DesignationOn(t, DesignationDefOf.ReleaseAnimalToWild) == null && !pawn.Dead && pawn.RaceProps.canReleaseToWild)
		{
			return true;
		}
		return false;
