...
public class Page_ConfigureIdeo : Page
{
	...
	private void Randomize()
	{
		...
		{
			ideo.foundation.Init(new IdeoGenerationParms(IdeoUIUtility.FactionForRandomization(ideo), forceNoExpansionIdeo: false, null, null, null, classic: false, forceNoWeaponPreference: false, ideo.Fluid));
