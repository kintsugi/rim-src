...
public class Recipe_AdministerIngestible : Recipe_Surgery
{
	...
	public override bool IsViolationOnPawn(Pawn pawn, BodyPartRecord part, Faction billDoerFaction)
	{
		...
		if (thingDef.IsNonMedicalDrug)
		{
			...
			{
				if (comp is CompProperties_Drug compProperties_Drug && compProperties_Drug.chemical != null && compProperties_Drug.chemical.addictionHediff != null && pawn.health.hediffSet.HasHediff(compProperties_Drug.chemical.addictionHediff))
				{
					return false;
				}
			}
