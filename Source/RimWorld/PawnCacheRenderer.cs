...
public class PawnCacheRenderer : MonoBehaviour
{
	...
	{
		pawn.Drawer.renderer.RenderCache(rotation, angle, positionOffset, renderHead, renderBody, portrait, renderHeadgear, renderClothes, overrideApparelColor, overrideHairColor, stylingStation);
	}
}
