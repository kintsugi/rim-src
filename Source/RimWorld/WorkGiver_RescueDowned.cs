...
public class WorkGiver_RescueDowned : WorkGiver_TakeToBed
{
	...
	{
		if (!(t is Pawn pawn2) || !pawn2.Downed || pawn2.Faction != pawn.Faction || pawn2.InBed() || pawn2.IsCharging() || !pawn.CanReserve(pawn2, 1, -1, null, forced) || GenAI.EnemyIsNear(pawn2, 40f) || CaravanFormingUtility.IsFormingCaravanOrDownedPawnToBeTakenByCaravan(pawn2))
		{
			return false;
		}
		Thing thing = null;
