...
public class RitualOutcomeEffectDef : Def
{
	...
	public string Description
	{
		get
		{
			...
			{
				foreach (OutcomeChance outcomeChance in outcomeChances)
				{
	...
	public OutcomeChance BestOutcome
	{
		get
		{
			...
			{
				bestOutcomeCached = outcomeChances.MaxBy((OutcomeChance o) => o.positivityIndex);
			}
	...
	public OutcomeChance WorstOutcome
	{
		get
		{
			...
			{
				worstOutcomeCached = outcomeChances.MinBy((OutcomeChance o) => o.positivityIndex);
			}
