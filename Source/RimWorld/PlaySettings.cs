...
public sealed class PlaySettings : IExposable
{
	...
	public void ExposeData()
	{
		...
		Scribe_Values.Look(ref defaultCareForColonySlave, "defaultCareForColonySlave", MedicalCareCategory.HerbalOrWorse);
	...
	public void DoPlaySettingsGlobalControls(WidgetRow row, bool worldView)
	{
		...
		else
		{
			...
			row.ToggleableIcon(ref showRoomStats, TexButton.ShowRoomStats, "ShowRoomStatsToggleButton".Translate(), SoundDefOf.Mouseover_ButtonToggle);
