...
public class JobDriver_Workwatching : JobDriver
{
	...
	protected override IEnumerable<Toil> MakeNewToils()
	{
		...
		toil.tickAction = delegate
		{
			...
			LearningUtility.LearningTickCheckEnd(base.pawn);
			if (!((adultToFollow.Position - base.pawn.Position).LengthHorizontal <= 3f) || !base.pawn.Position.WithinRegions(adultToFollow.Position, base.pawn.Map, 2, TraverseParms.For(base.pawn)))
			{
