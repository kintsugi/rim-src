	...
	public override void PostIdeoChosen()
	{
		...
		if (ModsConfig.BiotechActive)
		{
			...
			foreach (Ideo item in Find.IdeoManager.IdeosListForReading)
			{
				...
				{
					if (item2 is Precept_Xenotype precept_Xenotype && precept_Xenotype.customXenotype != null && !Current.Game.customXenotypeDatabase.customXenotypes.Contains(precept_Xenotype.customXenotype))
					{
