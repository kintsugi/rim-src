...
public class Alert_NeedBatteries : Alert
{
	...
	{
		TaggedString taggedString = "NeedBatteriesDesc".Translate() + "\n\n";
		if (ResearchProjectDefOf.Batteries.IsFinished)
		{
			return taggedString + "NeedBatteriesResearchedDesc".Translate();
		}
		return taggedString + "NeedBatteriesNotResearchedDesc".Translate();
	}
