...
public class MechPowerCellGizmo : Gizmo
{
	...
	public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
	{
		...
		TaggedString taggedString = "MechPowerCell".Translate();
		...
		TooltipHandler.TipRegion(rect2, () => "MechPowerCellTip".Translate(), Gen.HashCombineInt(powerCell.GetHashCode(), 34242369));
