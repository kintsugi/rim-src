...
public class MainTabWindow_Architect : MainTabWindow
{
	...
	public override void DoWindowContents(Rect inRect)
	{
		...
		{
			if (quickSearchWidget.filter.Active && architectCategoryTab != null && architectCategoryTab.UniqueSearchMatch != null)
			{
		...
		if (flag && Widgets.ButtonImage(new Rect(rect.xMax - 10f, rect.y, 24f, 24f).ContractedBy(2f), ChangeStyleIcon.Texture))
		{
