...
public class Pawn_TraderTracker : IExposable
{
	...
	public IEnumerable<Thing> ColonyThingsWillingToBuy(Pawn playerNegotiator)
	{
		...
		{
			IEnumerable<Building> enumerable2 = pawn.Map.listerBuildings.AllBuildingsColonistOfDef(ThingDefOf.GeneBank);
		...
		foreach (Pawn item4 in from x in TradeUtility.AllSellableColonyPawns(pawn.Map)
