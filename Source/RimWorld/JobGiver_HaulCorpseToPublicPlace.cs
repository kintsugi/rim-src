...
public class JobGiver_HaulCorpseToPublicPlace : ThinkNode_JobGiver
{
	...
	{
		if (!(pawn.MentalState is MentalState_CorpseObsession mentalState_CorpseObsession) || mentalState_CorpseObsession.corpse == null || mentalState_CorpseObsession.alreadyHauledCorpse)
		{
			return null;
		}
