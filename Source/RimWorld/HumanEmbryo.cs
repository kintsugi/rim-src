...
public class HumanEmbryo : GeneSetHolderBase
{
	...
	private Building_GrowthVat BestAvailableGrowthVat()
	{
		...
		{
			if (item is Building_GrowthVat building_GrowthVat && !building_GrowthVat.Working && building_GrowthVat.selectedEmbryo == null && building_GrowthVat.SelectedPawn == null)
			{
	...
	{
		TryPopulateGenes_NewTemp();
	}

	public bool TryPopulateGenes_NewTemp()
	{
		bool success = true;
		if (geneSet == null)
		{
