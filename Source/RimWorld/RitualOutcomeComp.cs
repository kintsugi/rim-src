...
public abstract class RitualOutcomeComp
{
	...
	public virtual ExpectedOutcomeDesc GetExpectedOutcomeDesc(Precept_Ritual ritual, TargetInfo ritualTarget, RitualObligation obligation, RitualRoleAssignments assignments, RitualOutcomeComp_Data data)
	{
		return null;
	}
	...
	public virtual void Notify_AssignementsChanged(RitualRoleAssignments assignments, RitualOutcomeComp_Data data)
	{
	}
