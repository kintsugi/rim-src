...
public class JobGiver_Tantrum : ThinkNode_JobGiver
{
	...
	{
		if (!(pawn.MentalState is MentalState_Tantrum mentalState_Tantrum) || mentalState_Tantrum.target == null || !pawn.CanReach(mentalState_Tantrum.target, PathEndMode.Touch, Danger.Deadly))
		{
			return null;
		}
		Verb verb = null;
