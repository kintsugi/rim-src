...
public class Graphic_RandomRotated : Graphic
{
	...
	public override void DrawWorker(Vector3 loc, Rot4 rot, ThingDef thingDef, Thing thing, float extraRotation)
	{
		...
		num += extraRotation;
		Graphics.DrawMesh(material: subGraphic.MatSingleFor(thing), mesh: mesh, position: loc, rotation: Quaternion.AngleAxis(num, Vector3.up), layer: 0, camera: null, submeshIndex: 0);
	}
