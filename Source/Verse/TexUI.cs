...
public static class TexUI
{
	...
	public static readonly Texture2D RectHighlight = ContentFinder<Texture2D>.Get("UI/Overlays/RoundedRectHighlight");

	public static readonly Texture2D RectTextHighlight = ContentFinder<Texture2D>.Get("UI/Overlays/RectVertHighlight");
