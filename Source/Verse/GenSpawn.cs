...
public static class GenSpawn
{
	...
	public static bool SpawningWipes(BuildableDef newEntDef, BuildableDef oldEntDef)
	{
		...
		if (thingDef2.IsBlueprint)
		{
			...
			{
				if (thingDef3 != null && thingDef3.building != null && thingDef3.building.canPlaceOverWall && thingDef2.entityDefToBuild is ThingDef thingDef4 && thingDef4.building != null && thingDef4.building.isPlaceOverableWall)
				{
					return true;
				}
		...
		if ((thingDef2.IsFrame || thingDef2.IsBlueprint) && thingDef2.entityDefToBuild is TerrainDef && buildableDef is ThingDef thingDef5 && !thingDef5.CoexistsWithFloors)
		{
			return true;
		}
