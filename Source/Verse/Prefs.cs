...
public static class Prefs
{
	...
	public static bool SimulateNotOwningIdology
	{
		get
		{
			...
			return data.simulateNotOwningIdeology;
		}
		set
		{
			if (data.simulateNotOwningIdeology != value)
			{
				data.simulateNotOwningIdeology = value;
				Apply();
			}
		}
	}
	...
	public static bool SimulateNotOwningBiotech
	{
		get
		{
			...
			return data.simulateNotOwningBiotech;
		}
		set
		{
			if (data.simulateNotOwningBiotech != value)
			{
				data.simulateNotOwningBiotech = value;
				Apply();
			}
		}
	}
