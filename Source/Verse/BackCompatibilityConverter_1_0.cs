...
public class BackCompatibilityConverter_1_0 : BackCompatibilityConverter
{
	...
	public override void PostExposeData(object obj)
	{
		...
		{
			if (obj is Game game && game.questManager == null)
			{
				game.questManager = new QuestManager();
			}
			if (obj is Zone zone && zone.ID == -1)
			{
		...
		if (obj is Pawn pawn && pawn.royalty == null)
		{
			pawn.royalty = new Pawn_RoyaltyTracker(pawn);
		}
		if (obj is Pawn_NativeVerbs pawn_NativeVerbs && pawn_NativeVerbs.verbTracker == null)
		{
