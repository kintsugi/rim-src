...
public class MouseoverReadout
{
	...
	public void MouseoverReadoutOnGUI()
	{
		...
		Widgets.Label(new Rect(BotLeft.x, (float)UI.screenHeight - BotLeft.y - num, 999f, 999f), MouseoverUtility.GetGlowLabelByValue(Find.CurrentMap.glowGrid.GameGlowAt(intVec)));
		num += 19f;
