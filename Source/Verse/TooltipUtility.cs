...
public static class TooltipUtility
{
	public static string ShotCalculationTipString(Thing target)
	{
		...
		if (Find.Selector.SingleSelectedThing != null)
		{
			...
			Verb verb = null;
			if (singleSelectedThing is Pawn pawn && pawn != target && pawn.equipment != null && pawn.equipment.Primary != null && pawn.equipment.PrimaryEq.PrimaryVerb is Verb_LaunchProjectile)
			{
			...
			if (verb != null)
			{
				...
				if (target is Pawn pawn2 && pawn2.Faction == null && !pawn2.InAggroMentalState && pawn2.AnimalOrWildMan())
				{
