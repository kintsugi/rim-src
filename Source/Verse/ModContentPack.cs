...
public class ModContentPack
{
	...
	public static readonly string[] ProductPackageIDs = new string[4] { "ludeon.rimworld", "ludeon.rimworld.royalty", "ludeon.rimworld.ideology", "ludeon.rimworld.biotech" };
	...
	public int SteamAppId => ModMetaData?.SteamAppId ?? 0;
