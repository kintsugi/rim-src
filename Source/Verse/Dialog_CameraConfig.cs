...
public class Dialog_CameraConfig : Window
{
	...
	public override void DoWindowContents(Rect rect)
	{
		...
		autoPanTargetAngle = Widgets.HorizontalSlider_NewTemp(rect4, autoPanTargetAngle, 0f, (float)Math.PI * 2f, middleAlignment: false, "Auto pan angle " + (autoPanTargetAngle * 57.29578f).ToString("F0") + "°", "0°", "360°", 0.01f);
		...
		autoPanSpeed = Widgets.HorizontalSlider_NewTemp(rect5, autoPanSpeed, 0f, 5f, middleAlignment: false, "Auto pan speed " + Config.autoPanSpeed, "0", "10", 0.05f);
