...
public class QuestNode_Root_Loot_AncientComplex : QuestNode_Root_AncientComplex
{
	...
	protected override ComplexDef ComplexDef => ComplexDefOf.AncientComplex_Loot;
	...
	protected override void RunInt()
	{
		if (BeforeRunInt())
		{
			...
			ComplexSketch ancientComplexSketch = GenerateSketch(num, generateTerminals: false);
